...
execute unless entity @s[nbt={Inventory:[{Slot:15b,id:"minecraft:diamond_ore"}]}] run item replace entity @s inventory.6 with minecraft:diamond_ore{display:{Name:'{"text":"Detector","color":"aqua","italic":false}'}}
...
execute unless entity @s[nbt={Inventory:[{Slot:24b,id:"minecraft:armor_stand"}]}] run item replace entity @s inventory.15 with minecraft:armor_stand{CustomModelData: 1, display: {Name: '{"text":"Cube","color":"gold","italic":false}'}, EntityTag: {NoGravity: 1b, Marker: 1b, Invisible: 1b, Tags: ["cubespawn", "levelsetup"]}}



execute unless entity @s[nbt={Inventory:[{Slot:25b,id:"minecraft:red_dye"}]}] run item replace entity @s inventory.16 with minecraft:red_dye{display: {Name: '{"text":"Enemies","color":"gold","italic":false}'}}
execute unless entity @s[nbt={Inventory:[{Slot:26b,id:"minecraft:armor_stand"}]}] run item replace entity @s inventory.17 with minecraft:armor_stand{CustomModelData: 2, display: {Name: '{"text":"Door [X]","color":"gold","italic":false}'}, EntityTag: {NoGravity: 1b, Marker: 1b, Invisible: 1b, Tags: ["door", "x", "inv"]}}
...
execute unless entity @s[nbt={Inventory:[{Slot:35b,id:"minecraft:feather"}]}] run item replace entity @s inventory.26 with minecraft:feather{display: {Name: '{"text":"Decoration","color":"gold","italic":false}'}}
