execute as @e[tag=blue,tag=bucket] at @s run particle minecraft:dust 0 0.7 1 0.5 ~ ~ ~ 0.1 0.1 0.1 1 8 force
execute as @e[tag=green,tag=bucket] at @s run particle minecraft:dust 0 1 0.2 0.5 ~ ~ ~ 0.1 0.1 0.1 1 8 force
execute as @e[tag=yellow,tag=bucket] at @s run particle minecraft:dust 1 0.8 0 0.5 ~ ~ ~ 0.1 0.1 0.1 1 8 force
execute as @e[tag=red,tag=bucket] at @s run particle minecraft:dust 1 0 0.5 0.5 ~ ~ ~ 0.1 0.1 0.1 1 8 force
