...
execute as @e[tag=turret,nbt={Glowing:1b}] at @s run particle minecraft:dust 1 0 0 1 ~ ~0.5 ~ 0.5 0.5 0.5 1 1 force @a
...
particle minecraft:dust 1 0 0 0.2 ~ ~ ~ 0 0 0 1 1 force @a
