execute as @a[gamemode=!spectator] at @s if block ~ ~-1 ~ #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~ ~2 ~ #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~-1 ~ ~ #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~1 ~ ~ #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~ ~ ~1 #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~ ~ ~-1 #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~-1 ~1 ~ #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~1 ~1 ~ #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~ ~1 ~1 #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~ ~1 ~-1 #paint:speed run effect give @s minecraft:speed 2 1 true
...
execute as @a[gamemode=!spectator] at @s if block ~1 ~ ~-1 #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~-1 ~ ~-1 #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~1 ~1 ~1 #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~-1 ~1 ~1 #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~1 ~1 ~-1 #paint:speed run effect give @s minecraft:speed 2 1 true
execute as @a[gamemode=!spectator] at @s if block ~-1 ~1 ~-1 #paint:speed run effect give @s minecraft:speed 2 1 true
