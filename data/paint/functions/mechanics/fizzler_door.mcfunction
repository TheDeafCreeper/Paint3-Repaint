...
execute as @e[tag=fizzlerdoor,tag=x] at @s if block ~ ~ ~ air run particle block tripwire ~ ~2.5 ~ 0 1 1 0 1
execute as @e[tag=fizzlerdoor,tag=z] at @s if block ~ ~ ~ air run particle block tripwire ~ ~2.5 ~ 1 1 0 0 1
